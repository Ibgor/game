init -2 python:
    ...
    class Enemy:
        def __init__(self,x,y,nemesyis):
            self.x = x
            self.y = y
            self.nemesyis = nemesyis
    ...
    player=Coordinate(0.5,0.5,0.05,0.05,0.95,0.95)
    winning_banner = Banner(0.5,0.5)
...
screen hamster_cage:
    ...
    add "potato sad" anchor (0.5,0.5) at Transform(function=player.transform)
